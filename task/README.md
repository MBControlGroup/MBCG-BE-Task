...
## 获取基本信息 `[/task] [GET]	// 点击“发布任务”时，获取常用地点、是否为单位/组织等信息`
request:
	null
response:
	200 OK
...
### 获取所有下属组织及人员 [/task/orgs] [GET]	// 点击"发布任务"时，服务器会返回可选择的组织、人员
request:
	null
response:
	200 OK
...
### 获取所有下属单位及成员 [/task/offices] [GET]	// 点击"发布任务"时，服务器会返回可选择的单位、人员
request:
	null
response:
	200 OK
...
// "执行中任务实时情况","响应情况","集合情况"参考了管理端的原型设计
