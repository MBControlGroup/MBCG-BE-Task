...
func (c Controller) SendMessgs(task *model.Task, soldierIDs map[int]bool) {
	...
	// 调用发送短信接口
	{
		resp, err := http.Post("http://222.200.180.59:9400/sendInterfaceTemplateSms?vars=3", "application/json", messgTemplatePayload)
		if err != nil {
	...
	// 调用发送语音接口
	{
		resp, err := http.Post("http://222.200.180.59:9400/webCall", "application/json", voiceTemplatePayload)
		if err != nil {
